...
- [[#development-tools][Development Tools]]
  ...
  - [[#documentation--introspection][Documentation and Introspection]]
  - [[#code-navigation][Code Navigation]]
  - [[#testing][Testing]]
  - [[#validation][Validation]]
  - [[#building][Building]]
  - [[#syntax-highlighting-and-visual-enhancements][Syntax highlighting and visual enhancements]]
...
**** auto-compile
     ...
     Compiles current file on save and can display compile errors/warnings in the mode-line.
