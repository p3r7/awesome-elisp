...
*** paren-face
   ...
   [[https://github.com/tarsius/paren-face][source]]

   Make parentheses less visible by dimming them.

*** page-break-lines

   [[https://github.com/purcell/page-break-lines][source]]

   Display form feed characters which are traditionally used to separate code sections as horizontal lines.
