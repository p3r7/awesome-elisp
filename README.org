...
*** Editing
    ...
    Honorable mention: [[https://github.com/joaotavora/yasnippet][YASnippet]], similar to =speed-of-thought-lisp= but less context-aware and requiring a specific key combination to trigger.
