...
*** ergoemacs - Practical Emacs Lisp
    ...
    One of the first resources on the web introducing elisp in a consice and and comprehensible way.
    ...
    To Xah's defense, some packages now considered standard are also writen this way (we're looking at you =ediff=).
