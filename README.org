...
**** IELM
     ...
     _standard_ (bundled with every Emacs install)
...
**** dash
     ...
     _informal standard_ (not bundled with Emacs, but used everywhere)
...
**** seq
     ...
     _standard_ (bundled with every Emacs install, since version 25)
