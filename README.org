...
** Profiling
   ...
   =profiler.el= is easilly toggled using =profiler-start=, =profiler-stop=. To obtain a result report call =profiler-report=.
...
*** etrace
    ...
    Wrapper around =elp.el= outputing a report in the /Chromium Catapult Trace Event Format/.
