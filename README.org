...
**** contract
     ...
     Provides data strcuture defintions as contracts (essentially interface description).
...
**** Relevant Content: Development Tools
     ...
     It's very tempting to list stuff such as =projectile= or =treemacs= but those package apply not only to Elisp development and should not be listed.
