...
*** Article: Take Your Emacs to the Next Level by Writing Custom Packages
    ...
    Real world experience of a user writing and submittinghis first package.
...
* Contributing
  ...
  The [[https://github.com/p3r7][original author]] made this document available as a gift to the community as he felt something like it was missing.

  The idea is to have this evolve into a community effort, the initial version is only a baseline.
...
*** PR and issues
    ...
    Open one issue of PR / subject matter.
