...
- [[#development-tools][Development Tools]]
  ...
  - [[#code-editing][Code Editing]]
    ...
    - [[#refactor-and-editing][Refactor and Editing]]
...
*** Search and Replace
    ...
    In Emacs regular expressions can make use of syntax information provided by the major-mode. This allows for complex symbol searches with =isearch= and =occur=.
    ...
    It's also worth mentioning the built-in =outline-mode= here which can be used to structure and navigate files by sections. 
...
**** speed-of-thought-lisp
     ...
     [[https://github.com/Malabarba/speed-of-thought-lisp][source]] provides smart way to make use of abbreviations in  Elisp.
...
**** elisp-docstring
     ...
     Simiplifies editing of docstrings. Handles escaping and unexcaping of quotes automatically.
...
**** aggressive-indent-mode
     ...
     [[https://github.com/Malabarba/aggressive-indent-mode][source]]
