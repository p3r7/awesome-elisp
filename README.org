...
**** tree-sitter
     ...
     Designed for parsing code into an [[https://en.wikipedia.org/wiki/Abstract_syntax_tree][AST]].
...
** Concurrency / Asynchronicity
   ...
   Emacs 26 added support for [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Threads.html][threads]], but those are not what you might be thinking of coming from other languages.
...
* Heroes
  ...
  In this section, we only list users who have significantly contributed with libraries and resources that improve the Emacs development experience.
